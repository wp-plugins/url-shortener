		...
		<form id="shorturloptions" method="post" action="options.php">
			...
			<div class="nl optsect">
				...
				<div id="enableurlservice" class="sub <?php if ($fts_urlfx['urlserviceenable'] != 'yes'){ echo "mhideit";} else {echo "mshowit";} ?>">
					...
					<fieldset>
						<div class="nl">
							<label class="betaserv">Enable Beta Functionality (Addional Services): </label>
							...
							<p><strong>Note: </strong>The <a href="<?php print $addonurl;?>">URL Shortener Beta Addon</a> Plugin has to be enabled.</p>
						</div>
					</fieldset>
				</div>
