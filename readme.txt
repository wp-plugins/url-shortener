...
** Beta Addon Support list **

* goo.gl (Google URL Shortener)
You can try out the following URL Shorterning services via the [URL Shortener Beta Addon Plugin](http://fusedthought.com/downloads/url-shortenerbeta-addon-wordpress-plugin/ "URL Shortener Beta Addon Plugin.")
